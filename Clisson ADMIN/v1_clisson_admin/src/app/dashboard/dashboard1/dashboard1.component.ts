...
export class Dashboard1Component implements OnInit {
    listofUser: any;
    listofSpecies: any;
    listofVarietyCategory: any;
    listOfVariety: any;
    listofRecipe: any;
    listofCropadvice: any
    ...
    ngOnInit() {
         this.userList();
        // this.speciesList(this.pageNo);
        this.varietyCategoryList();
        this.VarietyList();
        this.RecipeList();
        this.CropAdviceList();
    }
    ...
    userList() {
        ...
        this.authService.getUsers(page).subscribe(res => {
            ...
            if (res && res['status'] == 200) {
                this.listofUser = res['totalRecords']
            }
        })
    }
    // speciesList() {
    ...
    //         if (res && res['status'] == 200) {
    //             this.listofSpecies = res['data'].length
    //         }
    //     })
    // }

    varietyCategoryList() {
        this.authService.getVarietyCategoryList(this.pageNo).subscribe(res => {
            if (res && res['status'] == 200) {
                this.listofVarietyCategory = res['totalRecords']
            }
        })
    }

    VarietyList() {
        this.authService.getVarietyList(this.pageNo).subscribe(res => {
            if (res && res['status'] == 200) {
                this.listOfVariety = res['totalRecords']
            }
        })
    }
    RecipeList() {
        ...
        this.authService.getRecipeList(pageNo).subscribe(res => {
            ...
            if (res && res['status'] == 200) {
                this.listofRecipe = res['totalRecords']
            }
        })
    }
    CropAdviceList() {
        this.authService.getCropadvice(this.pageNo).subscribe(res => {
            if (res && res['data']) {
                this.listofCropadvice = res['totalRecords']
            }

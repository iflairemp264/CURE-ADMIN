...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/admin', title: 'Utilisateurs', icon: 'ft-user', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [
        // {path:'/admin/add',title: 'Admin add', icon: 'ft-user', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu:[]},
        // {path:'/admin/edit',title: 'Admin edit', icon: 'ft-user', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu:[]}
    ],
    },
    // { path: '/species', title: 'Species Mgmt', icon: 'ft-layers', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [
        
    // ], },
    { path: '/varietycategory', title: 'Espèces', icon: 'ft-file-text', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [
        // {path:'/varietycategory/add',title: 'Admin add', icon: 'ft-user', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu:[]},
        // {path:'/varietycategory/edit',title: 'Admin edit', icon: 'ft-user', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu:[]}
    ], },
    { path: '/variety', title: 'Variétés', icon: 'ft-grid', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    { path: '/cropadvice', title: 'Conseils de culture', icon: 'ft-box', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    { path: '/recipe', title: 'Recettes', icon: 'ft-message-square', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
